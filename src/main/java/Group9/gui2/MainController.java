...
import Group9.agent.factories.TacticalAgentFactory;
...
public class MainController implements Runnable {
    ...
    public MainController(Gui gui, File mapFile,boolean generateHistory){
        ...
        game = new Game(Parser.parseFile(mapFile.getAbsolutePath()), new TacticalAgentFactory(), false, 15, new Callback<Game>() {
            @Override
